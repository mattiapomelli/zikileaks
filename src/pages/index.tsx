...
function Home() {
  return (
    <>
      ...
      <section className="body-font rounded-md border-t bg-secondary text-gray-700 shadow-2xl">
      ...
      <section className="body-font rounded-md border-t border-gray-200 bg-secondary text-black shadow-2xl">
